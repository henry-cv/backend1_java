...
DROP TABLE IF EXISTS TURNOS; CREATE TABLE TURNOS (ID LONG AUTO_INCREMENT PRIMARY KEY, PACIENTE_ID LONG NOT NULL, ODONTOLOGO_ID LONG NOT NULL, FECHAHORA DATE NOT NULL);
...
INSERT INTO TURNOS (PACIENTE_ID, ODONTOLOGO_ID, FECHAHORA)
VALUES
(1, 1, '2023-06-15'),
(2, 2, '2023-06-18');