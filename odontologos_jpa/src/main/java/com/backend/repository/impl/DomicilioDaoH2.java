...
public class DomicilioDaoH2 implements IDao<Domicilio> {
  ...
  public Domicilio buscar(Long id) {
    ...
    if(domicilioBuscado == null)
      ...
      LOGGER.info("Se ha encontrado el domicilio: " + domicilioBuscado);
  ...
  private Domicilio crearObjetoDomicilio(ResultSet resultSet) throws SQLException {
    return new Domicilio(resultSet.getLong(1), resultSet.getString(2), resultSet.getInt(3), resultSet.getString(4),
