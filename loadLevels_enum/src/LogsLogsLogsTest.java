...
public class LogsLogsLogsTest {
  ...
  public void getShortLogOutputUnknown() {
    ...
    assertThat(logLine.getOutputForShortLog())
      .isEqualTo("0:We're no strangers to love");
  }
  ...
  public void getShortLogOutputTrace() {
    ...
    assertThat(logLine.getOutputForShortLog())
      .isEqualTo("1:You know the rules and so do I");
  }
  ...
  public void getShortLogOutputDebug() {
    var logLine = new LogLine(
      "[DBG]: A full commitment's what I'm thinking of"
    );
    assertThat(logLine.getOutputForShortLog())
      .isEqualTo("2:A full commitment's what I'm thinking of");
  }
  ...
  public void getShortLogOutputInfo() {
    var logLine = new LogLine(
      "[INF]: You wouldn't get this from any other guy"
    );
    assertThat(logLine.getOutputForShortLog())
      .isEqualTo("4:You wouldn't get this from any other guy");
  }
  ...
  public void getShortLogOutputWarning() {
    ...
    assertThat(logLine.getOutputForShortLog())
      .isEqualTo("5:I just wanna tell you how I'm feeling");
  }
  ...
  public void getShortLogOutputError() {
    ...
    assertThat(logLine.getOutputForShortLog())
      .isEqualTo("6:Gotta make you understand");
  }
  ...
  public void getShortLogOutputFatal() {
    ...
    assertThat(logLine.getOutputForShortLog())
      .isEqualTo("42:Never gonna give you up");
  }
}
